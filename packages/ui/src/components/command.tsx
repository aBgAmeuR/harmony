import { Icon, SearchIcon, Tick02Icon } from "@harmony/icons";
import {
  Dialog,
  DialogContent,
  DialogDescription,
...
import { InputGroup, InputGroupAddon } from "@harmony/ui/components/input-group";
  ...
  return (
    <div data-slot="command-input-wrapper" className="p-1 pb-0">
      <InputGroup className="h-8! bg-input/20 dark:bg-input/30">
        ...
        />
        <InputGroupAddon>
          <Icon icon={SearchIcon} strokeWidth={2} className="size-3.5 shrink-0 opacity-50" />
        </InputGroupAddon>
      </InputGroup>
    </div>
  );
