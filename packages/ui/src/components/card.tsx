...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "-mb-(--card-spacing) flex items-center rounded-b-lg border-t bg-muted/50 px-(--card-spacing) py-2",
        className,
      )}
      {...props}
    />
