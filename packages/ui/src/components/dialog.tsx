...
import { Icon, Cancel01Icon } from "@harmony/icons";
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn("-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-xl border-t bg-muted/50 px-4 py-2 sm:flex-row sm:justify-end ", className)}
      {...props}
    >
      {children}
      {showCloseButton && (
